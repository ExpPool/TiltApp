...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onStart(){
        ...
        if(sensorAccelerometer!=null){
            sensorAccelerometer.registerListener(this,sensorAccelerometer,SensorManager.SENSOR_DELAY_NORMAL);
        }
        if(sensorMagnetometer!=null){
            sensorMagnetometer.registerListener(this,sensorMagnetometer,SensorManager.SENSOR_DELAY_NORMAL);
        }
    }
    @Override
    ...
    public void onSensorChanged(SensorEvent sensorEvent){
        ...
        textSensorPitch.setText("Pitch (p) : "+ String.format("%.2f",pitch));
        textSensorRoll.setText("Roll (r) : "+ String.format("%.2f",roll));
